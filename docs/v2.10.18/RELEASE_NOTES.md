...
- Windows 远程 Checks 与三项 Release 资产 SHA-256 核对（待远程发布后补录）
...
GitHub Release：[v2.10.18](https://github.com/zhulongqihan/Focused-Moment/releases/tag/v2.10.18)。仅 Windows 资产；远端 Checks、Release 资产状态和 digest 在发布闭环完成后补录。
