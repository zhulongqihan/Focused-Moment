...
1. 下载最新版本：`Focused-Moment-v0.11.9.exe`
2. 双击运行即可使用（绿色版，无需安装）
...
**v0.11.9 - 发布链路加固与稳定性修复** (2026-04-05)

- 📥 [Focused-Moment-v0.11.9.exe](./Focused-Moment-v0.11.9.exe) (~15 MB)
...
- [更新日志](./CHANGELOG.md) - v0.11.9 发布变更
