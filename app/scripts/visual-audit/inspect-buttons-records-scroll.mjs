...
await page.waitForTimeout(500); await page.evaluate(() => { const scroller = document.querySelector(".nv-records-page"); if (scroller) scroller.scrollTop = scroller.scrollHeight; window.scrollTo(0, document.body.scrollHeight); }); await page.waitForTimeout(100);
