...
| 字段 | 当前值 |
| --- | --- |
| as_of / updated_at | 2026-09-10；根据最新截图反馈，Night Valley 第一套主题的“计时”页已完成本地实现与截图复核；v2.10.4 候选已通过本地门槛和正式 Windows 打包，正在进行提交、推送、远程 CI、macOS Universal 和 GitHub Release 闭环 |
| 产品目标 | 本地优先的桌面专注工具：待办 → 专注 → 桌面提醒 → 保存记录 → 回看投入 → 可恢复地长期保留 |
| 当前阶段 | 五套主题均已接入；v2.10.3 是线上基线；当前只处理第一套主题 Night Valley 的“计时”页，REFINE-08 本地候选完成，待发布闭环，不自动展开其他主题或页面 |
| 代码基线 | v2.10.3 发布代码提交为 `c4176ee`（`c4176ee33349a079df770b72f0d8fd11ac1f75e2`），tag `v2.10.3` 固定在同一提交；v2.10.2 tag 固定在 `fef30c7`；v2.10.1 tag 固定在 `4ceabf9`；v2.10.0 tag 固定在 `ce15ff0`；旧 v2.9.2 发布 tag 固定在 `9978e45` |
| 当前工作分支 | `main`；旧 CORE-01/CORE-02/CORE-03/CORE-04/CORE-05/NV-01/NV-02/NV-03/NV-04/NV-05/NV-06/DESK-01/DESK-02/DESK-03/ARCH-01/QA-01/PERF-01/TH-02/TH-03/TH-04/TH-05/DATA-01/REL-01 已完成；REFINE-03/REFINE-04/REFINE-05 DONE；REL-02/REL-03/REL-04 DONE；REFINE-06 REVIEW；REL-05 DONE；REFINE-07 REVIEW；REL-06 DONE |
| 发布基线 | GitHub `v2.10.3`，tag peeled commit 为 `c4176ee`；Checks `34429945507`、macOS Native Smoke `34429945494`、macOS Universal Release `34429994761` 均 PASS；Release 四项资产均为 uploaded，digest 见 `docs/v2.10.3/RELEASE_NOTES.md`；旧 tag 固定且未移动 |
| 远程 main | `origin/main` 当前仍为 `v2.10.3` 发布代码与证据；`v2.10.3` tag/Release 已固定且未移动；v2.10.4 候选尚未推送 |
...
| 下一项 | 完成 REFINE-08 的版本同步证据提交、推送、远程 CI、macOS Universal 与 GitHub Release digest 核对，再等待用户验收；不继续修改其他页面 |
| 当前执行人 / 在做任务 | Codex / REFINE-08 Night Valley Timer 计时器重构与全屏布局修复，当前为 v2.10.4 发布候选 |
...
| pending | REFINE-08 发布闭环尚未完成；REFINE-07 今日页等待用户验收；资源出处补录缺口仍按既有清单保留为后续治理事项 |
...
| REL-07 | P1 | DOING | REFINE-08 | v2.10.4 Night Valley Timer 发布闭环：版本同步、完整本地门槛、Windows 包、远程 main/CI、macOS Universal、GitHub Release 与四项资产 digest |
