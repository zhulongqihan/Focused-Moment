...
| pending | REFINE-17 本地验证无技术阻塞，REL-20 尚待远程 Checks/Release；远程 Checks 已成功，唯一记录为既有“每日一句”跨主题测试出现 1 flaky，workflow 总体 success；macOS 版本更新冻结，恢复前需用户明确授权；GitHub Actions 有 Node.js 20 弃用提示，但本轮检查成功且提示来自现有 action 版本；Night Valley 当前没有独立 F11/全屏产品命令，本轮结论限定为无边框窗口的全屏几何和 CSS 全屏布局；资源出处补录缺口仍按既有清单保留 |
...
### 2026-09-14 REFINE-17 / REL-20 Night Valley 待办工作台重构（本地验收完成）
...
- **当前状态**：REFINE-17 REVIEW；REL-20 DOING，待代码提交、推送、远程 Windows Checks、tag 和 GitHub Release；macOS 继续冻结。
