...
const copy = {
  ...
  heroVersion: "v0.2 \u6b63\u5411\u8ba1\u65f6",
  heroSummary:
    "\u8fd9\u4e00\u7248\u5148\u5b8c\u6210\u6700\u6838\u5fc3\u7684\u6b63\u5411\u8ba1\u65f6\u80fd\u529b\uff0c\u65f6\u95f4\u72b6\u6001\u7531 Rust \u4fdd\u5b58\u4e0e\u8ba1\u7b97\uff0c\u524d\u7aef\u53ea\u8d1f\u8d23\u663e\u793a\u4e0e\u64cd\u4f5c\u3002",
  loading: "\u6b63\u5728\u8f7d\u5165 v0.2 \u57fa\u7840\u80fd\u529b...",
  ready: "\u6b63\u5411\u8ba1\u65f6\u6838\u5fc3\u5df2\u63a5\u5165 Rust \u5f15\u64ce\u3002",
          ...
          <section class="timer-panel">
            ...
            <div class="timer-actions">
              <button
                ...
                onClick={() => void runTimerAction(startStopwatch)}
              >
                {copy.start}
              </button>
              <button
                ...
                class="action-button"
                disabled={timerBusy() || !timerSnapshot().isRunning || !timerReady()}
                onClick={() => void runTimerAction(pauseStopwatch)}
              >
                {copy.pause}
              </button>
              <button
                ...
                onClick={() => void runTimerAction(resetStopwatch)}
              >
                {copy.reset}
              </button>
              <button
                ...
                disabled={timerBusy() || timerSnapshot().elapsedMs === 0 || !timerReady()}
