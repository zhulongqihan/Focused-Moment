    ...
    <section class="ao-page ao-settings-page" aria-label="光场设置">
      ...
      <div class="ao-settings-grid">
        ...
        <div class="ao-settings-main">
          ...
          <AoGlass title="KEYS / 快捷键" note="INPUT / 04" class="ao-setting-card"><div id="ao-shortcuts" class="ao-shortcut-list"><div><span>开始 / 继续当前专注</span><kbd>Ctrl</kbd><b>+</b><kbd>Enter</kbd></div><div><span>结束并保存这一段</span><kbd>Ctrl</kbd><b>+</b><kbd>Shift</kbd><b>+</b><kbd>E</kbd></div><div><span>全屏切换</span><kbd>F11</kbd></div></div></AoGlass>
